...
export const LEVELS = [
  ...
  { id: 3, key: 'partial',   label: '進場過但沒看完',  labelJa: '入場したが途中まで', color: '#cf9a25', short: '進場', shortJa: '入場' },
  { id: 4, key: 'full',      label: '看完整場例行賽',  labelJa: '公式戦をフル観戦',   color: '#d0672e', short: '看完', shortJa: '観戦' },
  { id: 5, key: 'big',       label: '看過特別賽事（季後賽/總冠軍/明星賽/開幕戰/紀念活動）', labelJa: '特別な試合を観戦（ポストシーズン/優勝決定戦/オールスター/開幕戦/記念試合）', color: '#b83a34', short: '特別', shortJa: '特別' },
];
